...
export default function Footer() {
  ...
  return (
    <>
      <section className="text-white bg-foreground py-8 px-4 sm:px-6 lg:px-8 mt-16 max-w-7xl mx-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="footer-about">
            ...
            <p className="footer-about-desc text-base mb-6">
              ...
              collaboration and client satisfaction, we deliver tailored
          ...
          <div className="footer-contact-info">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:info@devstella.com"
