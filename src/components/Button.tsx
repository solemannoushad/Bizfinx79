...
function Button({ title, onClick, icon }: ButtonProps) {
  return (
    <button
      className="relative min-w-[150px] text-white overflow-hidden shadow-md uppercase text-sm text-center my-3 font-semibold py-3 px-6 cursor-pointer bg-secondary rounded-lg tracking-wider transition-all duration-300
