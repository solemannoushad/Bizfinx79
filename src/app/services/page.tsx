...
function page() {
  ...
  return (
    <>
      <Hero
        heading="services"
        subheading="Expert Accounting and Tax Solutions – Trusted by Companies Worldwide"
      />
        ...
        <div className="marquee-track">
          {[
            ...
            <div key={index} className="mx-10 flex-shrink-0 mt-20">
              <p className="px-6 py-4 bg-secondary font-semibold uppercase text-lg rounded-lg shadow-lg shadow-foreground">
                {logo}
              </p>
            </div>
          ))}
